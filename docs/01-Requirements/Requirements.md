...
## Module Requirements
The following sections describe the functional and component requirements for the actuation module of Team 307’s submersible exploration device. The module must enable reliable underwater propulsion using a motor driven propeller for forward and backwards motion, and incorporate a secondary motor to provide directional steering. The module also includes strech goals of a waterproofed system. 
